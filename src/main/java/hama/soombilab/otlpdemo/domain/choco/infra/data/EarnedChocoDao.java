...
public class EarnedChocoDao {
    ...
    @Column
    private BigDecimal chEarnedChoco;

    public static EarnedChocoDao from(UserDao userDao, Money finalPrice) {
        return EarnedChocoDao.builder()
            .userDao(userDao)
            .chEarnedChoco(finalPrice.amount())
            .build();
    }
}
